...
if TYPE_CHECKING:
    ...
    from crawlee.storage_clients._base._key_value_store_client import KeyValueStoreClient
...
class KeyValueStore:
    ...
    async def iterate_keys(
        ...
        """
        while True:
            list_keys = await self._client.iterate_keys(
    ...
    def _cache(self) -> dict[str, dict[str, JsonSerializable]]:
        ...
        if self.id not in self._general_cache:
            self._general_cache[self.id] = {}
        return self._general_cache[self.id]
