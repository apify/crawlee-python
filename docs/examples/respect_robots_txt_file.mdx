...
import OnSkippedRequest from '!!raw-loader!roa-loader!./code_examples/on_skipped_request.py';
...
<RunnableCodeBlock className="language-python" language="python" filename="respect_robots_txt_file.py">
    {RespectRobotsTxt}
</RunnableCodeBlock>
...
<RunnableCodeBlock className="language-python" language="python" filename="on_skipped_request.py">
    {OnSkippedRequest}
</RunnableCodeBlock>
