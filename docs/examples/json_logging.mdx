...
```json
{
    "text": "2025-03-11 19:48:51.927 | INFO     | crawlee.crawlers._basic._basic_crawler:run:580 - Final request statistics:\n",
    "record": {
        "elapsed": { "repr": "0:00:06.908244", "seconds": 6.908244 },
        "exception": null,
        "extra": {
            "requests_finished": 1,
            "requests_failed": 0,
            ...
            "request_avg_finished_duration": 5.869948,
            "requests_finished_per_minute": 10,
            "requests_failed_per_minute": 0,
            "request_total_duration": 5.869948,
            "requests_total": 1,
            "crawler_runtime": 5.891902
        },
        "file": {
            "name": "_basic_crawler.py",
            "path": "/crawlee/crawlers/_basic/_basic_crawler.py"
        },
        "function": "run",
        ...
        "process": { "id": 715998, "name": "MainProcess" },
        "thread": { "id": 140608499947328, "name": "MainThread" },
        "time": {
            "repr": "2025-03-11 19:48:51.927493+00:00",
            "timestamp": 1741722531.927493
        }
    }
}
```
