---
id: error-snapshotter
title: Error snapshotter
...
import ParselCrawlerWithErrorSnapshotter from '!!raw-loader!./code_examples/parsel_crawler_with_error_snapshotter.py';
import PlaywrightCrawlerWithErrorSnapshotter from '!!raw-loader!./code_examples/playwright_crawler_with_error_snapshotter.py';
