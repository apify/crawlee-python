...
import BeautifulSoupExampleExtractAndAdd from '!!raw-loader!./code_examples/extract_and_add_specific_links_on_website_bs.py';
import PlaywrightExampleExtractAndAdd from '!!raw-loader!./code_examples/extract_and_add_specific_links_on_website_pw.py';
