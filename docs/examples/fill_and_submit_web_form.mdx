...
```plaintext
...
[HttpCrawler] INFO  Processing https://httpbin.org/post ...
[HttpCrawler] INFO  Response: {
  "args": {},
  "data": "",
  "files": {},
  "form": {
...
│ request_avg_finished_duration │ 467.4ms │
│ requests_finished_per_minute  │ 124     │
│ requests_failed_per_minute    │ 0       │
│ request_total_duration        │ 467.4ms │
│ requests_total                │ 1       │
│ crawler_runtime               │ 485.3ms │
└───────────────────────────────┴─────────┘
```
