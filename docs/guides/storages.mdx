...
import RqHelperEnqueueLinksExample from '!!raw-loader!./code/storages/helper_extract_links_example.py';
...
<Tabs groupId="request_helpers">
    ...
    <TabItem value="request_helper_extract_links" label="Enqueue links">
        <CodeBlock className="language-python">
