...
Each storage client is responsible for maintaining the storages in a specific environment. This abstraction makes it easier to switch between different environemnts, e.g. between local development and cloud production setup.
