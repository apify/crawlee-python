...
import DatasetWithCrawler from '!!raw-loader!./code/result_storage_dataset_with_crawler.py';
import DatasetWithCrawerExplicit from '!!raw-loader!./code/result_storage_dataset_with_crawler_explicit.py';

import KvStoreBasicExample from '!!raw-loader!./code/result_storage_kvs_basic.py';
import KvStoreWithCrawler from '!!raw-loader!./code/result_storage_kvs_with_crawler.py';
import KvStoreWithCrawlerExplicit from '!!raw-loader!./code/result_storage_kvs_with_crawler_explicit.py';
