...
SqlDatasetClient --> dataset_metadata
SqlDatasetClient --> dataset_item

SqlKeyValueStoreClient --> kvs_metadata
SqlKeyValueStoreClient --> kvs_record
```
```mermaid
---
config:
...
SqlRequestQueueClient --> request_queue_metadata
SqlRequestQueueClient --> request
