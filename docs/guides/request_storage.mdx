...
This use case is supported via the <ApiLink to="class/RequestManagerTandem">`RequestManagerTandem`</ApiLink> class. You may also use the <ApiLink to="class/RequestSource#to_tandem">`RequestSource.to_tandem`</ApiLink> method as a shortcut.
