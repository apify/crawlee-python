...
title: Filling and submitting web forms
description: How to inspect a web form, prepare a POST request from its fields, and submit it with an HTTP crawler.
---
...
import RequestExample from '!!raw-loader!roa-loader!./code_examples/fill_and_submit_web_form/fill_and_submit_web_form_request.py';
import CrawlerExample from '!!raw-loader!roa-loader!./code_examples/fill_and_submit_web_form/fill_and_submit_web_form_crawler.py';
