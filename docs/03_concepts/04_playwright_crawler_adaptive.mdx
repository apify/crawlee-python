...
import AdaptivePlaywrightCrawlerBasicExample from '!!raw-loader!roa-loader!./code_examples/playwright_crawler_adaptive/adaptive_playwright_crawler.py';
...
The following example shows a complete crawler setup. The crawler decides per page whether to use the browser or plain HTTP, and the request handler works the same either way.

<RunnableCodeBlock className="language-python" language="python">
    {AdaptivePlaywrightCrawlerBasicExample}
</RunnableCodeBlock>
