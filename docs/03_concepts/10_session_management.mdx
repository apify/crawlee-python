...
For more details on configuring proxies, refer to the [Proxy management](./proxy-management) guide. To read, set, and persist cookies, see [Cookie management](./cookie-management).
