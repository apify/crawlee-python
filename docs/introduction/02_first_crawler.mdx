...
import RequestQueueExample from '!!raw-loader!./code/02_request_queue.py';
import BeautifulSoupExample from '!!raw-loader!./code/02_bs.py';
import BeautifulSoupBetterExample from '!!raw-loader!./code/02_bs_better.py';
