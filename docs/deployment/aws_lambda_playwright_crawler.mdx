...
title: Playwright crawler on AWS Lambda
...
In the Configuration tab, you can adjust resources. Playwright crawlers require more resources than HTTP-based crawlers:
