...
Update the project code to make it compatible with [Cloud Functions](https://cloud.google.com/functions) and return data in JSON format. Also add an entry point that Cloud Functions will use to run the project.
