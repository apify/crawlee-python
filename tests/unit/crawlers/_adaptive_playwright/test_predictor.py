...
@pytest.mark.parametrize(('url_1', 'url_2', 'expected_rounded_similarity'), [
...
def test_url_similarity(url_1: str, url_2: str, expected_rounded_similarity: float):
    assert round(calculate_url_similarity(
        url_1=get_url_components(url_1),
        url_2=get_url_components(url_2)), 2) == expected_rounded_similarity
